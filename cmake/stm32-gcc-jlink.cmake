...
# flash
configure_file(${CMAKE_SOURCE_DIR}/scripts/jlink-flash-stm32.jlink ${CMAKE_CURRENT_BINARY_DIR}/jlink-flash-stm32.jlink)
...
add_custom_target(jlink_erase 
	COMMAND ${JLINK_EXE} -Device ${JLINK_DEVICE} -Speed auto -if SWD -CommanderScript ${CMAKE_SOURCE_DIR}/scripts/jlink-erase-stm32.jlink
	)

# reset
add_custom_target(jlink_reset 
    COMMAND ${JLINK_EXE} -Device ${JLINK_DEVICE} -Speed auto -If SWD -CommanderScript ${CMAKE_SOURCE_DIR}/scripts/jlink-reset-stm32.jlink
)
